      ...
      <div className="relative z-10 flex flex-col justify-center items-center min-h-screen p-5">
        {
          loading ? (
            ...
            <form onSubmit={registerHandler} className="w-full max-w-md bg-primary-700 border-2 border-gray-300 rounded-xl shadow-2xl p-8 text-white">
              <h1 className="text-3xl font-bold text-center mb-6 border-b border-white pb-3">Register</h1>
              {error && (
              ...
              <div className="space-y-4">
                ...
                <Link href="/login" className="block text-center text-yellow-300 hover:text-yellow-200 transition-colors duration-200 mt-4 underline">
